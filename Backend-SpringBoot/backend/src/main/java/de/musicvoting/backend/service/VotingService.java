...
public class VotingService {
    ...
    public VotingService(RepositoryInMemory<Gast> gastSpeicher,
    ...
    public Gast getGast(String id) {
        return gastSpeicher.findById(id);
    }

    public Collection<Gast> getAllGaeste() {
        return gastSpeicher.findAll();
    }

    public Song getSong(String id) {
        return songSpeicher.findById(id);
    }

    public Collection<Song> getAllSongs() {
        return songSpeicher.findAll();
    }
